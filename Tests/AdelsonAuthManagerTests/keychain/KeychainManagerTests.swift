...
class KeychainManagerTests: XCTestCase {
    ...
    func testConfigureKeychainManagerSuccessfully() async{
        // Arrange
        let config = AdelsonAuthConfig.createTestConfig()
    ...
    func testPreventMultipleConfigurations() async{
        // Arrange
        let config1 = AdelsonAuthConfig.createTestConfig()
        let config2 = AdelsonAuthConfig.createTestConfig()
...
//    }
    ...
    func testServiceNameGeneration() async{
        // Arrange
        let config1 = AdelsonAuthConfig.createTestConfig()
        let config2 = AdelsonAuthConfig(appName: "TestApp2", baseUrl: "any", signUpEndpoint: "any", otpEndpoint: "verify-otp", loginEndpoint: "login", refreshTokenEndPoint: "refresh")
